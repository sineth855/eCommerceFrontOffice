...
<div class="col-lg-5 col-md-5 col-sm-5  col-xs-12">
    ...
    <div class="main-image  col-lg-12 no-padding style3">
        <a class="product-largeimg-link" href="product-details.html">
            <img src="{{url('assets/frontend/images/product_details/low-res-white/1.jpg')}}" class="img-responsive product-largeimg"
                alt="img">
        </a>
    </div>
    <!--/.main-image-->
    ...
    <div class="modal-product-thumb">
        <a class="thumbLink selected">
            <img data-large="images/product_details/low-res-white/1.jpg" alt="img" class="img-responsive" src="{{url('assets/frontend/images/product_details/low-res-white/1.jpg')}}">
        </a>
        <a class="thumbLink">
            <img data-large="images/product_details/low-res-white/2.jpg" alt="img" class="img-responsive" src="{{url('assets/frontend/images/product_details/low-res-white/2.jpg')}}">
        </a>
        <a class="thumbLink">
            <img data-large="images/product_details/low-res-white/3.jpg" alt="img" class="img-responsive" src="{{url('assets/frontend/images/product_details/low-res-white/3.jpg')}}">
        </a>
    </div>
    <!--/.modal-product-thumb-->
</div>
