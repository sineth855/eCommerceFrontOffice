<template>
    <div>
        ...
        <div class="modal fade" :id="ShowId(this.productId)" tabindex="-1" role="dialog"
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5  col-xs-12">
                        ...
                        <div class="main-image  col-lg-12 no-padding style3">
                            <a class="product-largeimg-link" href="">
                                <!--<img v-bind:src="productRecommanded.imagee" class="img-responsive product-largeimg" alt="img">-->
                            </a>
                        </div>
                        <!--/.main-image-->
...
<script>
    ...
    export default{
        ...
        mounted(){
            // this.productDetails(this.productId,0)
		},
        methods: {
            ShowId (product_id) {
