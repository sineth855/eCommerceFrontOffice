            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <td>
                  ...
                  <td>
                    <v-btn @click="viewEdit(props.item.length_class_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                    <v-btn @click="btnConfirm(props.item.length_class_id)"  depressed outline icon fab dark color="red" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/system/lengthClass'
  ...
  export default {
    data () {
      return {
        routeName: 'LengthClassForm',
        routeUrl: '/system/length_class',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
