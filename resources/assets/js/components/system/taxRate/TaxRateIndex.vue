            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <td>
                  ...
                  <td>{{ props.item.geo_zone }}</td>
                  <td>{{ props.item.rate }}</td>
                  <td>{{ props.item.type }}</td>
                  <td>
                    <v-btn @click="viewEdit(props.item.tax_rate_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                    <v-btn @click="btnConfirm(props.item.tax_rate_id)"  depressed outline icon fab dark color="red" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/system/taxRate'
  ...
  export default {
    data () {
      return {
        routeName: 'TaxRateForm',
        routeUrl: '/system/tax_rate',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
