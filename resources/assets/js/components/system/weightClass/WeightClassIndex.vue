            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <td>
                  ...
                  <td>
                    <v-btn @click="viewEdit(props.item.weight_class_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                    <v-btn @click="btnConfirm(props.item.weight_class_id)"  depressed outline icon fab dark color="red" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/system/weightClass'
  ...
  export default {
    data () {
      return {
        routeName: 'WeightClassForm',
        routeUrl: '/system/weight_class',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
