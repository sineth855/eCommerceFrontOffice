            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <template slot="items" slot-scope="props">
                  ...
                  <td>
                    <v-btn @click="viewEdit(props.item.supplier_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                    <v-btn @click="btnConfirm(props.item.supplier_id)"  depressed outline icon fab dark color="red" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/supplier/supplier'
  ...
  export default {
    data () {
      return {
        routeName: 'SupplierForm',
        routeUrl: '/supplier/suppliers',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
