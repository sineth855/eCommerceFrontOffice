            ...
            <v-widget :title="child_name" >
              <div slot="widget-content">
                <v-container>
                  ...
                  <v-layout row>
                    <v-flex xs3>
                      <v-subheader>Approval</v-subheader>
                    </v-flex>
                    <v-flex xs6>
                      <v-radio-group v-model="formData.approval" row>
...
<script>
  import {createData,editData,updateData} from '~/api/customer/customerGroup'
  ...
  export default {
    ...
    data () {
      return {
        parent_name:'Customer Group',
        child_name:'Customer Group Form',
    ...
    methods: {
      ...
      getData() {
        editData(this.id).then(response => {
          ...
          this.formData.approval = ""+response['data']['approval']+""
