...
<script>
  import {createData,editData,updateData} from '~/api/catalog/categoryType'
  ...
  export default {
    ...
    data () {
      return {
        parent_name:'Category Type',
        child_name:'Category Type Form',
        routeName:'Category Type',
        valid: true,
        notifyStatus: '',
        message: '',
        flash: Flash.state,
