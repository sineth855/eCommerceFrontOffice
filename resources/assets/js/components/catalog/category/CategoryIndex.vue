            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <td>
                  ...
                  <td>
                    <v-btn @click="viewEdit(props.item.category_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                    <v-btn @click="btnConfirm(props.item.category_id)"  depressed outline icon fab dark color="red" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/catalog/category'
