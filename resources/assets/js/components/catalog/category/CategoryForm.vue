    ...
    methods: {
      ...
      getData() {
        editData(this.id).then(response => {
          // fetch all form data
          this.formData.image = response['data']['general']['image'];
          this.imagePreview = response['data']['general']['image'];
          this.formData.name = response['data']['general']['name'];
          this.formData.description = response['data']['general']['description'];
          this.formData.meta_description = response['data']['general']['meta_description'];
          this.formData.meta_title = response['data']['general']['meta_title'];
          this.formData.meta_keyword = response['data']['general']['meta_keyword'];
          this.formData.parent_id = response['data']['general']['parent_id'];
          this.formData.sort_order = response['data']['general']['sort_order'];
          this.formData.column = response['data']['general']['column'];
          this.formData.top = response['data']['general']['top'];
          this.formData.store = response['data']['store'];
          this.formData.filter = response['data']['filter'];
          this.formData.status = response['data']['general']['status'];
