            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <td>
                  ...
                  <td>
                    <v-btn @click="viewEdit(props.item.attribute_group_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                    <v-btn @click="btnConfirm(props.item.attribute_group_id)"  depressed outline icon fab dark color="red" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/catalog/attributeGroup'
  ...
  export default {
    data () {
      return {
        routeName: 'AttributeGroupForm',
        routeUrl: '/catalog/attribute_group',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
