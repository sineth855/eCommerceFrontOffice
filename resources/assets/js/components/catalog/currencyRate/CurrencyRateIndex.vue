            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <td>
                  ...
                  <td>{{ props.item.symbol_left }}</td>
                  <td>{{ props.item.symbol_right }}</td>
                  <td>{{ props.item.decimal_place }}</td>
                  ...
                  <td>
                    <v-btn @click="viewEdit(props.item.currency_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                    <v-btn @click="btnConfirm(props.item.currency_id)"  depressed outline icon fab dark color="red" small>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/catalog/currencyRate'
  ...
  export default {
    data () {
      return {
        routeName: 'CurrencyRateForm',
        routeUrl: '/catalog/currency_rate',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
