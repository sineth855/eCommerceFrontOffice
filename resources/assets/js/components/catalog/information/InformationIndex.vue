            ...
            <v-card-text class="pa-0">
              <v-data-table
                ...
                <td>
                  ...
                  <td>
                    <v-btn @click="viewEdit(props.item.information_id)" depressed outline icon fab dark color="primary" small>
                      <v-icon>edit</v-icon>
                    </v-btn>
                  </td>
                </template>
...
<script>
  ...
  import {fetchList,updateData,deleteData} from '~/api/catalog/information'
  ...
  export default {
    data () {
      return {
        routeName: 'InformationForm',
        routeUrl: '/catalog/information',
        search: '',
        items: [],
        notifyStatus: '',
        message: '',
